...
/**
 * Test whether the KafkaIdempotentRepository successfully recreates its cache from pre-existing topics.
 * This guarantees that the de-duplication state survives application instance restarts.
 *
